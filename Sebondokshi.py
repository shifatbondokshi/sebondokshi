...
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mShifatBondokshi.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈

\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈

\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲

\033[1;96m................\033[1;93mShifatBondokshi\033[1;91m...............

\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : SE_SHIFAT_BONDOKSHI

\033[1;92m☞ WhatsApp   : 03232132362

\033[1;95m☞ YouTube    : https://youtube.com/@shifatbondokshi
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update SE_BONDOKSHI Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' SE_BONDOKSHI WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/SE_BONDOKSHI')

	    os.system('cd $HOME && https://github.com/shifatbondokshi')
	    ...
	    psb('WhatsApp Num 01927755908✓')

	    psb('WellCome To SE_BONDOKSHI')

	    psb('Congratulations SE_BONDOKSHI Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ 786786✓')

	    psb('🔓Password ☆ 786786✓')

	    psb('Subscrib My Youtube Channel Shifat_bondokshi✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/SE_BONDOKSHI && python2 B4.py')
